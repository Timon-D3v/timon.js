...
function getElm(id, caller = document) {
  ...
  try {
    ...
    if (DEBUG) console.warn("Shorthand attr is not available. Use the function 'attribute' instead.");
  }
