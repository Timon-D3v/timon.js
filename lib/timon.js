...
function errorField(message = "Etwas hat nicht geklappt. Versuche es in einigen Sekunden erneut.", time = 5000) {
	...
	const span = output = document.createElement("span");
  
	field.style.cssText = "display: block; position: fixed; bottom: 5vh; left: 50%;\
	transform: translateX(-50%); max-width: 70vw; margin: 0; padding: 20px;\
	background-color: #d61c35; background-color: var(--error); opacity: 1; box-sizing:\
	border-box; border-radius: 15px; font-size: 20px; line-height: 1.25; z-index: 1000000;";
	img.style.cssText = "height: 1lh; aspect-ratio: 1/1; object-fit: contain;\
	object-position: center; transform: translateY(20%); margin-right: 0.25em;";
	...
	setTimeout(() => {
	  if (typeof gsap?.version === "string") gsap.to(field, {opacity: 0, display: "none", duration: time / 1000, ease: "power2.in"});
	  else {
