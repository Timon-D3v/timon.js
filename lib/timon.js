...
function getElm(id, caller = document) {
  ...
  if (typeof element === "undefined") {
    console.warn(`The element with id ${id} on ${caller} does not exist!`);
    const errorFunction = () => {
      console.error(`The element with id ${id} on ${caller} does not exist!`);
    };
    return {
      on: errorFunction,
      click: errorFunction,
...
function getQuery(query, caller = document) {
  ...
  if (typeof elements === "undefined") {
    console.warn(`The element with query ${query} on ${caller} does not exist!`);
    const errorFunction = () => {
      console.error(`The element with query ${query} on ${caller} does not exist!`);
    };
    return {
      on: errorFunction,
      click: errorFunction,
